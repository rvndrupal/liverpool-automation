...
test.describe('Liverpool — Nintendo Switch: Flujo E2E de búsqueda', () => {
  ...
  test('Buscar "nintendo switch", filtrar, ordenar y extraer los primeros 5 productos', async ({ page }) => {
    let uiProducts   = [];
    let totalResults = 0;
